        ...
        <div class="row">
            <div class="col-md-4">
                <div style="margin-top: 20px; margin-bottom: 10px;">
                    <span >开始日期</span>
                    <span><input class="property property-white" id="startDate"  required type="date" name="startDate"></span>
                </div>
                <div style="margin-top: 10px; margin-bottom: 10px;">
                    <span >结束日期</span>
                    <span><input class="property property-white" id="endDate"  required type="date" name="endDate"></span>
                </div>
                <script type="text/javascript" language="JavaScript">
